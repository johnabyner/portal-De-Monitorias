...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'name', example: 'carlos', required: false }),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Atualizar usuario' }),
    (0, swagger_1.ApiParam)({ name: 'matricula', example: '20230001' }),
    (0, swagger_1.ApiBody)({
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Deletar usuario' }),
    (0, swagger_1.ApiParam)({ name: 'matricula', example: '20230001' }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
