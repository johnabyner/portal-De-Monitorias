...
const disciplines_repository_1 = require("./disciplines.repository");
...
exports.DisciplinesModule = DisciplinesModule = __decorate([
    (0, common_1.Module)({
        providers: [database_service_1.DatabaseService, disciplines_repository_1.DisciplinesRepository],
        exports: [disciplines_repository_1.DisciplinesRepository]
    })
], DisciplinesModule);
